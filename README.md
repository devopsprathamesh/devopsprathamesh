...
<img src="https://skillicons.dev/icons?i=jenkins,gitlab,git" alt="ci/cd" />

**Infrastructure as Code & Automation**

<img src="https://skillicons.dev/icons?i=terraform,ansible,python,bash,mysql,linux" alt="iac and automation" />

![Ansible Tower/AWX](https://img.shields.io/badge/Ansible_Tower%2FAWX-EE0000?style=flat-square&logo=ansible&logoColor=white)
...
![Cosign](https://img.shields.io/badge/Cosign-image_signing-blue?style=flat-square)
![Nexus](https://img.shields.io/badge/Nexus-artifact_repo-1B1B1B?style=flat-square)
...
A fully automated Kubernetes homelab — `git clone` → `make up` → a real 4-node
kubeadm cluster (1 control plane + 3 workers) on Vagrant + VirtualBox, with Cilium
as the CNI and Ansible bootstrapping everything entirely inside the VMs. Every
node's CPU/RAM/disk is configurable through a single `config.yaml` to fit whatever
machine you're running it on — live-tested end to end, including a genuine
